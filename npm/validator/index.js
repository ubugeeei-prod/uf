...
// `npm/validator/validator.test.js` covers each of those, including
// `@uniflowed/form`'s resolver over both a synchronous and an asynchronous
// schema, and `npm/form/form.test.js` covers that resolver inside a real
// form.
//
...
//
//   UF_PROJECT_ROOT=$PWD node --import ./npm/host/register.js \
