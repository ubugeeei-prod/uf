...
// reaches it: this is the exact module `npm/vite/index.js` gates on.
import { isFlowModule } from "../../npm/host/transform.js";
import {
  COMPILE_ASSETS_ID,
...
describe("the payload uf's transform must never be asked about", () => {
  it("enters the graph under an id `isFlowModule` declines", () => {
    // The whole fix in one line. `isFlowModule` is what `npm/vite`'s
