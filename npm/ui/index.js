...
// the state of every part is a table in `npm/ui/ui.test.js` rather than a
...
// registry of styled components in `npm/ui/registry/` that is embedded into the
 ...
 * element. See the module headers and the table in `npm/ui/ui.test.js`.
 */
