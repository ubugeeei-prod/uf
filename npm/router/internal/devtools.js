...
// script above every module — see `npm/vite/internal/devtools.js`, which
...
// `development: true`, both asserted in `npm/vite/devtools.test.js`
 ...
 * `npm/vite/devtools.test.js` asserts the two spellings agree, which is
