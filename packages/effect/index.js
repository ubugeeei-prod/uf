...
//
// Nothing else in uf builds on this file's internals, and this file imports
// nothing. If a genuinely separable subject ever arrives — a scheduler with
// its own state, a tracing layer — it earns its own module at the package
// root with its own subpath, and the test in
// `crates/uf_lib/tests/package_surface.rs` will insist on that rather than
// letting it hide under `internal/`.
