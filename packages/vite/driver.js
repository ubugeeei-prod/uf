...
const ADAPTERS = {
  node: {
    entries: (document, cache, build, schedules, regeneration, partial) => ({
      handler: handlerEntrySource(document, cache, NODE_CAPABILITIES, build, regeneration, partial),
  ...
  bun: {
    entries: (document, cache, build, schedules, regeneration, partial) => ({
      handler: handlerEntrySource(document, cache, BUN_CAPABILITIES, build, regeneration, partial),
  ...
  deno: {
    entries: (document, cache, build, schedules, regeneration, partial) => ({
      handler: handlerEntrySource(document, cache, DENO_CAPABILITIES, build, regeneration, partial),
  ...
  edge: {
    entries: (document, cache, build, schedules, regeneration, partial) => ({
      handler: handlerEntrySource(document, cache, EDGE_CAPABILITIES, build, regeneration, partial),
  ...
  serverless: {
    entries: (document, cache, build, _schedules, regeneration, partial) => ({
...
async function deploy() {
  ...
  const entries = shape.entries(document, cacheConfig, buildId, schedules, regeneration, partial);
  const input = {};
 ...
 */
function handlerEntrySource(document, cache, capabilities, build, regeneration, partial) {
