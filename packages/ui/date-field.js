...
export component DateField(...options: DateFieldProps) {
  return <SegmentedField options={options} time={false} />;
}
export component TimeField(...options: DateFieldProps) {
  return <SegmentedField options={options} time />;
}
