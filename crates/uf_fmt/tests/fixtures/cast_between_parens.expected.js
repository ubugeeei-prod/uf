  ...
  if (a) {
    if (b) {
      if (c) {
        ...
        const p8 = (rootToCommitProfilingMetadataMap as any as CommitProfilingMetadataMapLXY).get(
          aa,
        );
        // And so is the lookup.
        const p1 = (rootToCommitProfilingMetadataMap as any as CommitProfilingMetadataMapLongXY)
          .prop;
        const p2 = (rootToCommitProfilingMetadataMap as any as CommitProfilingMetadataMapLonXY)[
          keyy
        ];
        // `new` is not a call for this purpose, so its arguments break instead.
        const p3 = new (rootToCommitProfilingMetadataMap as any as CommitProfilingMetadataMapLXY)(
          aa,
        );
        // Nor is a cast that is nobody's object or callee.
        const p4 =
          !(rootToCommitProfilingMetadataMapXY as any as CommitProfilingMetadataMapLongeXY);
        const p9 = callSomething(
          rootToCommitProfilingMetadataMapLongerName as any as ProfilingMapx,
        );
      }
    }
  }
