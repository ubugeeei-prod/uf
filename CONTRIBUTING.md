...
PRs first run quick checks. When a release PR enters the merge queue, it runs
the full integration suite and builds and installs all five native archives.
