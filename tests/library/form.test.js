...
// `// expect:` comment, and `./type-tests.js` reads both and compares them — so
// a change that makes one of them stop being an error fails here, and so does
// one that makes something else in that file start being one.
