...
- [ ] Support PPR, SSR, SSG, and ISR. SSG, SSR and ISR are **Implemented** and
      ...
      document that never existed (#336, #385). PPR is **Planned**: naming it
      is allowed and selects nothing, and a list naming only it is refused.
