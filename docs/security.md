...
| A credential printed into a log by a diagnostic | `uf inspect` and every banner report the mode, the file names and the variable *names*; no command prints a value | `uf_cli::commands::inspect` |
