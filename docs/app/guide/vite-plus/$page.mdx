...
**What you will be able to do:** say where uf and Vite+ overlap and where they
differ, what Vite+ has that uf does not, and whether the two can be used
together.

**What you need first:** nothing installed. [uf compared](/guide/compare) covers
...
[Benchmarks](/guide/benchmarks) is next: every uf command timed beside Vite+
and the other tools on one machine, with the rows uf loses first.
