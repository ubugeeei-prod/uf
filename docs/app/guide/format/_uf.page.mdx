...
What is written parses, `uf fmt --check` still passes, and running it twice is
running it once. The [CLI reference](/reference/cli) spells out each of those
and what the exit status means.
