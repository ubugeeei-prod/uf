...
| `uf test` | Rust owns discovery, scheduling, timeouts and reports; hosts execute test bodies and unsupported hosts say why they skipped | [Testing](/guide/testing) and `npm/test` |
...
| UI | The public API is behavior, accessibility and styling freedom; render escape hatches keep ids, handlers, refs and Flow constraints intact | [UI components](/guide/ui) and `npm/ui/ui.test.js` |
