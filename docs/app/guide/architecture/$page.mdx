...
| UI | The public API is behavior, accessibility and styling freedom; render escape hatches keep ids, handlers, refs and Flow constraints intact | [Headless components](/guide/ui) and `packages/ui/ui.test.js` |
