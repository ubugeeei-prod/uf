...
There is no mouse wheel, because there is no mouse
([#314](https://github.com/ubugeeei-prod/uf/issues/314)), and no horizontal
scrolling: content wider than a terminal is nearly always content that should
have wrapped.
...
Mouse input, text selection, images, the rich-content components (`Code`,
