...
"RSC and browser testing" job type-checks it and runs its tests whenever the
pipeline runs in full. Each sample on this page is checked on every pull request
