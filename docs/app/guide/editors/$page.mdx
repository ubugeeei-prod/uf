---
title: "Editors · uf"
description: "uf lsp in VS Code, Cursor, Neovim, Vim, Helix and Emacs: what it answers, what it does not, and the config it reads."
---
...
([#977](https://github.com/ubugeeei-prod/uf/issues/977)):
...
Not working. [`editors/zed`](https://github.com/ubugeeei-prod/uf/tree/main/editors/zed)
...
([#977](https://github.com/ubugeeei-prod/uf/issues/977)). Meanwhile `uf fmt`,
