...
What it does not answer: completion, go-to-definition, rename, find-references,
document symbols, and the type at a position. It advertises none of them, and a
request for one is refused rather than left waiting:
...
[#941](https://github.com/ubugeeei-prod/uf/issues/941). Until the server answers
