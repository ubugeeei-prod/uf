...
- **Type errors in the editor.** `uf lsp` publishes lint diagnostics and no type
  errors. It does answer types — hover, go to definition and member completion
  come from this checker — see [Editors](/guide/editors).
