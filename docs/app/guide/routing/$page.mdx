...
and metadata before a page renders; navigate; and answer requests with
...
from, and what a click does. [Server Components](/guide/server-components) is
what decides which of these modules reach the browser.
