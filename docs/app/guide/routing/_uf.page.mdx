...
declaration to `serve` yet — so on those targets, pass your schedules to
`serve` yourself as above. `serverless` has no configuration file uf writes at
all. [#531](https://github.com/ubugeeei-prod/uf/issues/531) tracks the rest.
