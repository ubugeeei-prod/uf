...
| Server actions | exported async functions in `"use server"` modules are callable by id | inline action references ([#1360](https://github.com/ubugeeei-prod/uf/issues/1360)) and a server function passed to a client component as a prop ([#1359](https://github.com/ubugeeei-prod/uf/issues/1359)); a form works before hydration ([Server actions](/guide/server-actions#before-the-page-hydrates)) |
...
- **A server function passed to a client component as a prop.** A client
  ...
  are not wired ([#1359](https://github.com/ubugeeei-prod/uf/issues/1359)).
