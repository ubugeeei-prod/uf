...
| Server actions | exported async functions in `"use server"` modules are callable by id | inline action references ([#1360](https://github.com/ubugeeei-prod/uf/issues/1360)), a server function passed to a client component as a prop ([#1359](https://github.com/ubugeeei-prod/uf/issues/1359)), and a form that submits before hydration ([#1358](https://github.com/ubugeeei-prod/uf/issues/1358)) |
