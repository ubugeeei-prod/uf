...
- **Progressive enhancement.** A form that submits before its JavaScript has
  ...
  at all. No open issue tracks it.
...
- **Inline `"use server"` closures, and a server function as a prop.** A closure
  ...
  client component as a prop either. No open issue tracks either; write a module
  export, and import it from the client component.
