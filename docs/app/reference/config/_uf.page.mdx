...
What `staticBuild` describes is what the *ordinary* build leaves behind.
...
builder uf ships. A second one for Rolldown, rspack or esbuild is
[#549](https://github.com/ubugeeei-prod/uf/issues/549) and is Planned;
`crates/uf_cli/tests/fixtures/paper-builder` is a conformance fixture rather
than a builder to use.
