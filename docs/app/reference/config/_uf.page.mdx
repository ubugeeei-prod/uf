...
| `runtime.deploy.adapters` | `["node"]` | The targets this project may build for. One by default, because one is implemented; naming any of the other six is an error that says so ([#391](https://github.com/ubugeeei-prod/uf/issues/391)) |
