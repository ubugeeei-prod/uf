...
| --- | --- | --- |
| `Button` | a real `<button>` plus a style preset | The behaviour is already in HTML; the design decision is visual |
| `Card`, `Badge`, `Label`, `Input`, `Textarea` | plain elements plus presets | With no styles they are wrappers around one element, and wrappers lose props |
