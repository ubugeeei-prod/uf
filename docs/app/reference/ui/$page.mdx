...
| `RangeDatePicker` | two `DatePicker`s, until range semantics are implemented | A date range is not two strings; it needs its own announcements and keyboard rules |
...
| Standalone collection primitives | Not shipped: standalone ListBox, GridList, Tree and TagGroup still need a collection/state contract of their own | [#1309](https://github.com/ubugeeei-prod/uf/issues/1309) |
...
| Range and segmented date/time fields | Not shipped: RangeCalendar, DateRangePicker, DateField and TimeField | [#1311](https://github.com/ubugeeei-prod/uf/issues/1311) |
| Number field | Not shipped: locale parsing, formatting, stepping and validation need their own primitive | [#1313](https://github.com/ubugeeei-prod/uf/issues/1313) |
...
| Drag/drop and color controls | Not shipped: drag/drop hooks, collection drop targets and ColorPicker | [#1310](https://github.com/ubugeeei-prod/uf/issues/1310) |
| Locale and direction infrastructure | Partial: component-local keyboard maps exist, but there is no I18nProvider-style locale/direction layer | [#1312](https://github.com/ubugeeei-prod/uf/issues/1312) |
