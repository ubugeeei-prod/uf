...
| `Tabs.List` | `div role="tablist"` | `renders* Tabs.Tab`; owns the arrow-key handler |
...
| `Dialog.Overlay` | `div aria-hidden` | Rendered only while open; decoration, not the dismissal logic |
